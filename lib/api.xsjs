...
switch (service) {
	...
	case 'NewWidgetDialog':
		...
		break;
	case 'DeleteWidget':
        output = JSON.stringify(widgetLib.deleteWidget());
		break;
	case 'DeleteMetricHistory':
        output = JSON.stringify(widgetLib.deleteMetricHistory());
		break;
	case 'CloneMetric':
        output = widgetLib.cloneMetric();
		break;
	case 'CreateMetric':
        output = widgetLib.createMetric();
		break;
	case 'EditMetric':
        output = widgetLib.editMetric();
		break;
	...
	case 'AddAlert':
		...
		break;
	case 'CreateAlert':
		output = alertLib.createAlert();
		break;
	case 'EditAlert':
		output = alertLib.editAlert();
		break;
	...
	case 'CreateDashboard':
        output = dashboardLib.createDashboard();
		break;
	case 'UpdateDashboard':
	    output = dashboardLib.updateDashboard();
	    break;
	case 'DeleteDashboard':
        output = dashboardLib.deleteDashboard();
		break;
	case 'SetSharingURL':
