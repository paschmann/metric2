...
var viewmode = $.request.parameters.get("viewmode");
...
switch (service) {
    ...
    case "WidgetHistoryDialog":
        ...
        Dataset.dashboardwidgetid = dashboardwidgetid;
        Dataset.startdt = startdt;
        Dataset.enddt = enddt;
        output = JSON.stringify(Dataset);
        break;
    ...
    case "DeleteDashboard":
        ...
        output = JSON.stringify(Dataset);
        break;
    case "SetMetricSharingURL":
        Dataset.shareURL = widgetLib.setShareURL(Math.random().toString(36).slice(2));
        output = JSON.stringify(Dataset);
        break;
    case "GetMetricSharingURL":
        Dataset.shareURL = widgetLib.getShareURL();
        output = JSON.stringify(Dataset);
        break;
    case "DisableMetricSharingURL":
        Dataset.shareURL = widgetLib.setShareURL("");
        output = JSON.stringify(Dataset);
        break;
        // metricdata Functions //
    case "SetDashboardSharingURL":
        Dataset.shareURL = dashboardLib.setShareURL(Math.random().toString(36).slice(2));
        output = JSON.stringify(Dataset);
        break;
    case "GetDashboardSharingURL":
        Dataset.shareURL = dashboardLib.getShareURL();
        output = JSON.stringify(Dataset);
        break;
    case "DisableDashboardSharingURL":
        Dataset.shareURL = dashboardLib.setShareURL("");
        output = JSON.stringify(Dataset);
        break;
        // metricdata Functions //
    case "API":
