...
output += "<br />" +  executeUpdate('GRANT AFL__SYS_AFL_AFLPAL_EXECUTE TO M2_SVC_ACCOUNT');

//output += "<br />" +  executeUpdate('UPDATE "_SYS_XS" ."SQL_CONNECTIONS" SET username = \'M2_SVC_ACCOUNT\' WHERE name = \'lilabs.metric2::metricuser\'');
output += "<br />" +  executeUpdate('UPDATE "_SYS_XS" ."SQL_CONNECTIONS" SET username = \'SYSTEM\' WHERE name = \'lilabs.metric2::metricuser\'');
...
output += "<br />" +  executeUpdate('CREATE SEQUENCE "METRIC2"."ALERT_MAIL_ID" START WITH 1');
...
// Tables
output += "<br />" +  executeUpdate('CREATE ROW TABLE "METRIC2"."M2_ALERT"  ( "ALERT_ID" INT CS_INT NOT NULL, "DASHBOARD_WIDGET_ID" INT CS_INT, "COND" VARCHAR(40) CS_STRING, "OPERATOR" VARCHAR(40) CS_STRING, "VALUE" REAL CS_FLOAT, "NOTIFY" VARCHAR(200) CS_STRING, "USER_ID" INT CS_INT, "STATUS" INT CS_INT DEFAULT 1, "LAST_EXECUTED" LONGDATE CS_LONGDATE DEFAULT CURRENT_TIMESTAMP, "CREATED_ON" LONGDATE CS_LONGDATE DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY ( "ALERT_ID" ) ) ');
output += "<br />" +  executeUpdate('CREATE ROW TABLE "METRIC2"."M2_ALERT_HISTORY"  ( "ALERT_HIST_ID" INT CS_INT NOT NULL, "ALERT_ID" INT CS_INT, "DASHBOARD_WIDGET_ID" INT CS_INT, "COND" VARCHAR(40) CS_STRING, "OPERATOR" VARCHAR(40) CS_STRING, "VALUE" REAL CS_FLOAT, "NOTIFY" VARCHAR(200) CS_STRING, "ACTUAL" REAL CS_FLOAT, "ADDED" LONGDATE CS_LONGDATE DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY ( "ALERT_HIST_ID" ) ) ');
output += "<br />" +  executeUpdate('CREATE ROW TABLE "METRIC2"."M2_DASHBOARD"  ( "DASHBOARD_ID" INT CS_INT NOT NULL, "TITLE" VARCHAR(100) CS_STRING, "SUBTITLE" VARCHAR(100) CS_STRING, "DT_ADDED" LONGDATE CS_LONGDATE, "USER_ID" INT CS_INT, "REFRESH_RATE" INT CS_INT, "WIDTH" INT CS_INT, "HEIGHT" INT CS_INT, "BG_COLOR" VARCHAR(10) CS_STRING, "TV_MODE" INT CS_INT, PRIMARY KEY ( "DASHBOARD_ID" ) ) ');
output += "<br />" +  executeUpdate('CREATE ROW TABLE "METRIC2"."M2_DASHBOARD_WIDGET"  ( "DASHBOARD_WIDGET_ID" INT CS_INT NOT NULL, "DASHBOARD_ID" INT CS_INT, "WIDGET_ID" INT CS_INT, "TITLE" VARCHAR(100) CS_STRING, "WIDTH" INT CS_INT, "HEIGHT" INT CS_INT, "ROW_POS" INT CS_INT, "COL_POS" INT CS_INT, "REFRESH_RATE" INT CS_INT DEFAULT 0, PRIMARY KEY ( "DASHBOARD_WIDGET_ID" ) ) ');
output += "<br />" +  executeUpdate('CREATE ROW TABLE "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS"  ( "DASHBOARD_WIDGET_PARAM_ID" INT CS_INT NOT NULL, "DASHBOARD_WIDGET_ID" INT CS_INT, "PARAM_ID" INT CS_INT, "VALUE" VARCHAR(1000) CS_STRING, "WIDGET_ID" INT CS_INT, "DT_ADDED" LONGDATE CS_LONGDATE, PRIMARY KEY ( "DASHBOARD_WIDGET_PARAM_ID" ) ) ');
output += "<br />" +  executeUpdate('CREATE ROW TABLE "METRIC2"."M2_DWP_HISTORY"  ( "DWP_HIST_ID" INT CS_INT NOT NULL, "DASHBOARD_WIDGET_PARAM_ID" INT CS_INT NOT NULL, "DT_ADDED" LONGDATE CS_LONGDATE DEFAULT CURRENT_TIMESTAMP, "VALUE" VARCHAR(100) CS_STRING, PRIMARY KEY ( "DWP_HIST_ID" ) ) ');
output += "<br />" +  executeUpdate('CREATE ROW TABLE "METRIC2"."M2_PAL_TS_FIXEDVALS"  ( "ID" INT CS_INT ) ');
output += "<br />" +  executeUpdate('CREATE ROW TABLE "METRIC2"."M2_USER_CONNECTIONS"  ( "CONNECTION_ID" INT CS_INT NOT NULL, "USER_ID" INT CS_INT, "NAME" VARCHAR(40) CS_STRING, "STRING" VARCHAR(200) CS_STRING, PRIMARY KEY ( "CONNECTION_ID" ) ) ');
output += "<br />" +  executeUpdate('CREATE ROW TABLE "METRIC2"."M2_USERS"  ( "USER_ID" INT CS_INT NOT NULL, "NAME" VARCHAR(100) CS_STRING, "LNAME" VARCHAR(100) CS_STRING, "ACCT_TYPE" INT CS_INT, "EMAIL" VARCHAR(100) CS_STRING NOT NULL, "PASSWORD" VARCHAR(100) CS_STRING, "EMAIL_DOMAIN" VARCHAR(100) CS_STRING, "DT_ADDED" LONGDATE CS_LONGDATE, "USER_TOKEN" VARCHAR(100) CS_STRING, PRIMARY KEY ( "USER_ID", "EMAIL" ) ) ');
output += "<br />" +  executeUpdate('CREATE ROW TABLE "METRIC2"."M2_WIDGET"  ( "WIDGET_ID" INT CS_INT, "NAME" VARCHAR(100) CS_STRING, "ICON_URL" VARCHAR(200) CS_STRING, "TYPE" VARCHAR(40) CS_STRING, "CODE" VARCHAR(100) CS_STRING, "CODE_TYPE" VARCHAR(100) CS_STRING, "DESCRIPTION" VARCHAR(200) CS_STRING, "WIDGET_GROUP" INT CS_INT, "HIST_ENABLED" INT CS_INT DEFAULT 0, "DEF_HEIGHT" INT CS_INT, "DEF_WIDTH" INT CS_INT ) ');
output += "<br />" +  executeUpdate('CREATE ROW TABLE "METRIC2"."M2_WIDGET_PARAM"  ( "PARAM_ID" INT CS_INT, "WIDGET_ID" INT CS_INT, "NAME" VARCHAR(100) CS_STRING, "TYPE" VARCHAR(100) CS_STRING, "VALUE_DEFAULT" VARCHAR(1000) CS_STRING, "INDEX_NO" INT CS_INT, "REQUIRED" INT CS_INT, "PLACEHOLDER" VARCHAR(100) CS_STRING, "DISPLAY_NAME" VARCHAR(100) CS_STRING, "VISIBLE" VARCHAR(10) CS_STRING, "OPTION_GROUP" INT CS_INT, "HIST_ENABLED" INT CS_INT DEFAULT 0, "HIST_DATAPOINT" VARCHAR(10) CS_STRING) ');
output += "<br />" +  executeUpdate('CREATE ROW TABLE "METRIC2"."M2_WIDGET_PARAM_OPTIONS"  ( "OPTION_ID" INT CS_INT NOT NULL, "VALUE" VARCHAR(200) CS_STRING, "DISPLAY_VALUE" VARCHAR(200) CS_STRING, "OPTION_GROUP" INT CS_INT, PRIMARY KEY ( "OPTION_ID" ) ) ');
...
output += "<br />" +  executeUpdate('CREATE TABLE "METRIC2"."M2_OUTGOING_EMAIL" ("ID" INT, "EMAILTO" VARCHAR(255), "EMAILFROM" VARCHAR(255), "SUBJECT" VARCHAR(255), "CONTENTS" VARCHAR(2000), "SENT" VARCHAR(100))');
...
output += "<br />" +  executeUpdate('CREATE VIEW "METRIC2"."M2_WIDGET_BLOCKEDTRANS" ( "CNT" ) AS SELECT COUNT(HOST) AS CNT FROM SYS.M_BLOCKED_TRANSACTIONS WITH READ ONLY');
...
output += "<br />" +  executeUpdate('CREATE VIEW "METRIC2"."M2_WIDGET_SYS_MEM" ( "SM" ) AS SELECT round(sum(VALUE/1024/1024/1024),1) as SM FROM SYS.M_MEMORY WHERE NAME = \'SYSTEM_MEMORY_SIZE\' AND PORT = \'30003\' WITH READ ONLY');
...
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET" VALUES (9,\'DB CPU Usage History\',\'9.png\',\'Query\',\'widgetHistChart\',\'Javascript\',\'A history of CPU for the HANA Database Instance\',1,1,1,1)');
...
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET" VALUES (14,\'Resident Memory Usage History\',\'14.png\',\'Query\',\'widgetHistChart\',\'Javascript\',\'A line chart showing the memory usage history\',1,1,1,1)');
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET" VALUES (15,\'Date and Time\',\'15.png\',\'Static\',\'widgetDateTime\',\'Client\',\'A Date and Time Widget\',1,0,null,null)');
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET" VALUES (16,\'Connection History\',\'16.png\',\'Query\',\'widgetHistChart\',\'Javascript\',\'A historical chart showing the recent connection count\',1,1,null,null)');
...
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET" VALUES (29,\'Sensor (API)\',\'29.png\',\'WebService\',\'widgetSensorAPI\',\'Javascript\',\'Displays a physical temperature from a sensor\',6,1,null,null)');
...
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET" VALUES (34,\'Number and History\',\'34.png\',\'Query\',\'widgetHistorySmall\',\'Javascript\',\'Displays a value, icon and small history chart below the number\',2,1,null,null)');
...
// widgetIcon
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET_PARAM" VALUES (9,5,\'ICONURL\',\'URL\',\'\',100,1,\'Full URL Path to your icon (200px x 100px)\',\'URL Link\',\'true\',null,0, null)');
...
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET_PARAM" VALUES (152,9,\'UOM1\',\'Static\',\'%\',300,1,\'Required, Unit of measure\',\'Text\',\'false\',2,0, null)');
...
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET_PARAM" VALUES (38,10,\'SQL1\',\'SQL\',\'SELECT CNT FROM METRIC2.M2_WIDGET_BLOCKEDTRANS\',200,0,\'SQL Statement to fetch the current count of blocked transactions\',\'SQL Query\',\'false\',null,1, \'VALUE\')');
...
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET_PARAM" VALUES (128,34,\'ICONURL\',\'URL\',\'\',500,0,\'Optional: Full URL Path to your icon (200px x 100px)\',\'URL Link\',\'true\',null,0, null)');
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET_PARAM" VALUES (130,34,\'LINECOL\',\'Static\',\'#CCCCCC\',600,0,\'HTML Color: Color of the sparkline\',\'Sparkline Color\',\'true\',null,0, null)');
...
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET_PARAM" VALUES (146,40,\'ICONURL\',\'URL\',\'\',300,0,\'Full URL Path to your icon (200px x 100px)\',\'URL Link\',\'true\',null,0, null)');
...
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET_PARAM_OPTIONS" VALUES (3,\'Â°F\',\'Â°F\',2)');
output += "<br />" +  executeUpdate('INSERT INTO "METRIC2"."M2_WIDGET_PARAM_OPTIONS" VALUES (4,\'Â°C\',\'Â°C\',2)');
...
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD" values(1,\'Overview\',null,null,1,null,null,null,null,null)');

// Create Widgets on Overview Dashboard
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET" values(1,1,4,\'All Service Started\',1,1,1,1,0)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(1,1,7,\'SELECT VALUE FROM METRIC2.M2_WIDGET_ALLSTARTED_VALUE\',4,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(2,1,6,\'localserver\',4,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(3,1,8,\'SELECT STATUS FROM METRIC2.M2_WIDGET_ALLSTARTED\',4,CURRENT_TIMESTAMP)');

output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET" values(2,1,7,\'Instance Details\',1,1,1,2,0)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(4,2,22,\'SELECT VALUE FROM METRIC2.M2_WIDGET_INSTANCEID\',7,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(5,2,21,\'localserver\',7,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(6,2,23,\'SELECT VALUE FROM METRIC2.M2_WIDGET_INSTANCENUMBER\',7,CURRENT_TIMESTAMP)');


output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET" values(3,1,8,\'Current Connections\',1,1,1,4,10)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(7,3,24,\'localserver\',8,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(8,3,27,\'SELECT CNT FROM METRIC2.M2_WIDGET_RUNNINGCONNETIONS\',8,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(9,3,30,\'0\',8,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(10,3,26,\'Users\',8,CURRENT_TIMESTAMP)');

output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET" values(4,1,12,\'Component Overview\',3,1,2,1,0)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(11,4,44,\'SELECT STATUS FROM METRIC2.M2_WIDGET_SYSOVERVIEW\',12,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(12,4,43,\'localserver\',12,CURRENT_TIMESTAMP)');


output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET" values(5,1,15,\'Time (PST)\',1,1,1,3,0)');


output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET" values(6,1,21,\'System Overview\',4,1,3,1,0)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(13,6,75,\'localserver\',21,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(14,6,76,\'SELECT SM FROM METRIC2.M2_WIDGET_TOTAL_CPU\',21,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(15,6,77,\'SELECT SM FROM METRIC2.M2_WIDGET_SYS_MEM\',21,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(16,6,80,\'SELECT VALUE FROM METRIC2.M2_WIDGET_DISTRIBUTED_VALUE\',21,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(17,6,79,\'SELECT VALUE FROM METRIC2.M2_WIDGET_ALLSTARTED_VALUE\',21,CURRENT_TIMESTAMP)');


output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET" values(7,1,35,\'Tables Sizes\',2,1,2,4,0)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(18,7,132,\'localserver\',35,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(19,7,134,\'SELECT * FROM METRIC2.M2_WIDGET_ROWCOLSIZES\',35,CURRENT_TIMESTAMP)');

output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET" values(8,1,17,\'Las Vegas Weather\',1,1,1,5,0)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(20,8,70,\' 89104\',17,CURRENT_TIMESTAMP)');


output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET" values(9,1,30,\'SAP Stock Price\',1,1,3,5,360)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(21,9,122,\'SAP\',30,CURRENT_TIMESTAMP)');


output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET" values(10,1,31,\'@metricsquared\',2,3,1,6,0)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(22,10,112,\' @metricsquared\',31,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(23,10,115,\'385571773112012800\',31,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(24,10,113,\'5\',31,CURRENT_TIMESTAMP)');

output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET" values(11,1,27,\'Connections\',2,1,4,1,0)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(25,11,102,\'SELECT STATUS FROM METRIC2.M2_WIDGET_CONNECTIONS\',27,CURRENT_TIMESTAMP)');


output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET" values(12,1,9,\'CPU Usage\',1,1,3,5,10)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(26,12,32,\'localserver\',9,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(27,12,36,\'line\',9,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(28,12,35,\'20\',9,CURRENT_TIMESTAMP)');
output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_DASHBOARD_WIDGET_PARAMS" values(29,12,33,\'SELECT CPU FROM METRIC2.M2_WIDGET_DB_CPU\',9,CURRENT_TIMESTAMP)');

//INSERT a sample history for CPU
// DWP ID, min value, max value, start hour, end hour, add_days
output += "<br />" +  executeUpdate('CALL METRIC2.M2_P_HISTGENERATOR(29, 1, 20, 1, 19, -1)');
output += "<br />" +  executeUpdate('CALL METRIC2.M2_P_HISTGENERATOR(29, 80, 90, 20, 22, -1)');
output += "<br />" +  executeUpdate('CALL METRIC2.M2_P_HISTGENERATOR(29, 1, 20, 23, 23, -1)');


output += "<br />" +  executeUpdate('INSERT into "METRIC2"."M2_ALERT" values("METRIC2"."ALERT_ID".NEXTVAL, 12,\'value\',\'>\',80,\'\',1,0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)');
}
