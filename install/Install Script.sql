...
CREATE ROW TABLE "METRIC2"."M2_DASHBOARD"  ( "DASHBOARD_ID" INT CS_INT NOT NULL, "TITLE" VARCHAR(100) CS_STRING, "SUBTITLE" VARCHAR(100) CS_STRING, "DT_ADDED" LONGDATE CS_LONGDATE, "USER_ID" INT CS_INT, "REFRESH_RATE" INT CS_INT, "WIDTH" INT CS_INT, "HEIGHT" INT CS_INT, "BG_COLOR" VARCHAR(10) CS_STRING, "TV_MODE" INT CS_INT, "VIEWORDER" INT CS_INT, "SHARE_URL" VARCHAR(40) CS_STRING, PRIMARY KEY ( "DASHBOARD_ID" ) ) ;
...
INSERT INTO METRIC2.M2_DASHBOARD_WIDGET_PARAMS SELECT METRIC2.DASHBOARD_WIDGET_PARAM_ID.NEXTVAL, METRIC2.DASHBOARD_WIDGET_ID.CURRVAL, PARAM_ID, VALUE, WIDGET_ID, DT_ADDED FROM METRIC2.M2_DASHBOARD_WIDGET_PARAMS WHERE DASHBOARD_WIDGET_ID = :v_dwid; END;
