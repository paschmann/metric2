...
CREATE ROW TABLE "METRIC2"."M2_DASHBOARD"  ( "DASHBOARD_ID" INT CS_INT NOT NULL, "TITLE" VARCHAR(100) CS_STRING, "SUBTITLE" VARCHAR(100) CS_STRING, "DT_ADDED" LONGDATE CS_LONGDATE, "USER_ID" INT CS_INT, "REFRESH_RATE" INT CS_INT, "WIDTH" INT CS_INT, "HEIGHT" INT CS_INT, "BG_COLOR" VARCHAR(10) CS_STRING, "TV_MODE" INT CS_INT, "VIEWORDER" INT CS_INT, PRIMARY KEY ( "DASHBOARD_ID" ) ) ;
