...
(function($) {
	...
	$.fn.graphup.painters.bars = function($cell, o) {
		...
		var celldata = $cell.html() != 0 ? $cell.html() : ''; 
		
		$cell.html(
			'<div style="position:relative; padding:' + $cell.css('padding-top') + ' ' + $cell.css('padding-right') + ' ' + $cell.css('padding-bottom') + ' ' + $cell.css('padding-left') + '; height:100%;">' +
				'<div class="' + o.classBar + '" style="position:absolute; ' + position + ' background-color:rgb(' + color + '); z-index:1;"></div>' +
				'<div style="position:relative; z-index:2;">' + celldata  + '</div>' +
			'</div>'
		).css('padding', 0);
	};
